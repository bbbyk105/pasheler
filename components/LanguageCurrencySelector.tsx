...
export default function LanguageCurrencySelector({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <span>{languageLabels[language]} | {currencyLabels[currency]}</span>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-1 w-48 bg-white border border-stone-200 rounded-lg shadow-lg z-50">
          <div className="p-3 border-b border-stone-100">
            <h3 className="text-xs font-medium text-stone-600 mb-2">Language / 言語</h3>
          ...
          <div className="p-3">
            <h3 className="text-xs font-medium text-stone-600 mb-2">Currency / 通貨</h3>
            <div className="space-y-1">
